...
function OrgProfile() {
  ...
  useEffect(() => {
    const getProfile = async () => {
      try {
        const response = await getOrganizerProfile(id as string);
  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden font-display mt-20">
      {/* Background Image */}
      <div
      ...
      {/* Content */}
      <main className="relative z-10 flex flex-col items-center px-4 sm:px-8 py-16">
