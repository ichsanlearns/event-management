          ...
          <div className="max-w-[1000px] mx-auto bg-white dark:bg-[#1E1B2E] rounded-3xl shadow-2xl border border-gray-100 dark:border-gray-700 p-3 md:p-4">
            <form className="flex flex-col lg:flex-row gap-3">
              <div className="relative flex-grow group">
                ...
                <input
                  className="block w-full pl-12 pr-4 py-4 border-none rounded-2xl bg-gray-50 dark:bg-gray-800/50 text-gray-900 dark:text-white placeholder-gray-400 focus:ring-0 focus:bg-white dark:focus:bg-gray-800 transition-all text-lg font-medium"
              ...
              <div className="flex flex-col sm:flex-row gap-3">
                ...
                <button
                  className="flex-shrink-0 bg-primary hover:bg-primary-dark text-white font-bold py-3.5 px-8 rounded-2xl transition-all shadow-lg shadow-indigo-500/20 active:scale-95 flex items-center justify-center gap-2 text-lg"
                  type="button"
                >
                  Search
                </button>
