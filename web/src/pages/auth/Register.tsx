      ...
      <section className="hidden md:flex md:w-1/2 bg-[#6344d4] p-16 flex-col justify-between text-white relative">
        ...
        <div className="z-10">
          ...
          <h1 className="text-5xl font-bold leading-tight mb-6 max-w-md">
            Discover the pulse of your creative city.
          </h1>
          <p className="text-purple-100 text-lg max-w-sm leading-relaxed opacity-80">
            Join over 50,000 creators and fans discovering unique concerts,
            workshops, and high-energy gatherings every day.
          </p>
        </div>
        ...
        <div className="z-10 bg-white/10 backdrop-blur-xl border border-white/20 p-8 rounded-3xl max-w-md shadow-2xl">
          ...
          <p className="italic text-base mb-6 leading-relaxed text-purple-50">
            "EventFlow changed how I host my photography workshops. The
            ticketing process is seamless and the community is incredible."
          </p>
          ...
          <form className="space-y-5" onSubmit={handleRegister}>
            ...
            <div className="flex items-center gap-3 py-2">
              <input
                type="checkbox"
                id="terms"
                className="w-4 h-4 rounded border-slate-300 text-[#6344d4] focus:ring-[#6344d4]"
              />
              <label
                htmlFor="terms"
              ...
              >
                I agree to the{" "}
                <span className="text-[#6344d4] font-bold cursor-pointer hover:underline">
                  Terms of Service
                </span>{" "}
                and{" "}
                <span className="text-[#6344d4] font-bold cursor-pointer hover:underline">
