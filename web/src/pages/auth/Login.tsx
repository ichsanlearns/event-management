  ...
  return (
    <main className="w-full h-screen flex font-sans bg-white dark:bg-[#0f172a] transition-colors duration-300 overflow-hidden">
      ...
      <section className="hidden lg:flex lg:w-1/2 relative overflow-hidden bg-slate-900">
        ...
        <div className="relative z-10 flex flex-col justify-between h-full p-16 text-white">
          ...
          <div className="max-w-md">
            ...
            <p className="text-xl text-slate-300 leading-relaxed mb-10 opacity-90">
              Join thousands of fans discovering the most exclusive concerts and
              workshops worldwide.
            </p>
            ...
            <div className="bg-white/10 backdrop-blur-xl border border-white/10 p-8 rounded-3xl flex items-start gap-5 shadow-2xl">
              ...
              <div>
                <p className="text-lg font-medium text-white italic leading-snug">
                  "The easiest way to find and manage my event tickets.
                  Everything is just one tap away."
                </p>
                <p className="text-sm text-indigo-300 font-semibold mt-3">
                  — Alex Rivera, Music Curator
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="text-sm text-slate-500 font-medium">
            © 2026 EventFlow Platform. All rights reserved.
          </div>
        </div>
      </section>
      ...
      <section className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-16 bg-white dark:bg-[#0f172a] overflow-y-auto">
        <div className="w-full max-w-105">
          ...
          <form className="space-y-6" onSubmit={handleLogin}>
            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center">
                <input
                  id="remember"
                  type="checkbox"
                  className="h-4 w-4 text-[#6366f1] focus:ring-[#6366f1] border-slate-300 dark:border-slate-600 rounded cursor-pointer dark:bg-slate-800"
                />
                <label
                  htmlFor="remember"
                  className="ml-2 block text-sm text-slate-600 dark:text-slate-400 cursor-pointer font-medium"
                >
                  Remember me
                </label>
              </div>
            ...
            <button
              disabled={loading}
              className="w-full flex justify-center py-4 px-4 rounded-2xl shadow-xl shadow-indigo-500/20 text-base font-bold text-white bg-[#6366f1] hover:bg-indigo-700 transition-all active:scale-[0.98]"
            >
          ...
          <div className="mt-10 relative">
            ...
            <div className="relative flex justify-center text-xs uppercase tracking-widest font-bold">
              <span className="px-4 bg-white dark:bg-[#0f172a] text-slate-400">
                Or continue with
              </span>
            </div>
          </div>
          ...
          <p className="mt-12 text-center text-slate-500 dark:text-slate-400 font-medium">
            ...
            <Link
              to="/register"
              className="font-bold text-[#6366f1] hover:underline transition-all ml-1"
            >
              Start for free
            </Link>
          </p>
      ...
      <button
        ...
        className="fixed bottom-8 right-8 p-4 bg-white dark:bg-slate-800 shadow-2xl rounded-full border border-slate-200 dark:border-slate-700 transition-all hover:scale-110 active:scale-90 z-50 group"
      >
        {isDarkMode ? (
          <Sun
          ...
          <Moon
            className="text-slate-700 group-hover:-rotate-12 transition-transform"
            size={24}
          />
        )}
      </button>
