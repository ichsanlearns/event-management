    ...
    <main className="min-h-screen bg-slate-50 flex justify-center items-center p-6">
      <div className="w-full max-w-xl bg-white rounded-3xl shadow-xl p-8">
        ...
        <div className="flex items-center gap-4 mb-10">
          ...
          <div>
            <p className="text-2xl font-bold text-slate-800">{user.name || user.username || user.full_name || "-"}</p>
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-3 bg-slate-50 p-4 rounded-xl">
            ...
            <span className="text-slate-700 font-medium">{user.email || user.email_address || "-"}</span>
          </div>
        ...
        <div className="mt-10 space-y-4">
          <button className="w-full flex items-center justify-center gap-2 py-3 rounded-xl hover:bg-indigo-400  bg-indigo-600 text-white font-bold">
            <Edit size={18} />
            Edit Profile
          </button>

          <button onClick={handleLogout} className="w-full flex items-center justify-center gap-2 py-3 rounded-xl bg-red-500 hover:bg-red-600 text-white font-bold transition-all">
            <LogOut size={18} />
            Logout
          </button>
        </div>
